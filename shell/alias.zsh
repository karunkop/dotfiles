...
alias tmkal2="tmux new-session -s kalysysv2 -nserver -c ~/Documents/code/kalysysv2/server \; attach-session -c ~/ \; new-window -nconsole -c ~/Documents/code/kalysysv2/server \;  send-keys 'clear' C-m \; select-window -t 1 \; send-keys 'vim' C-m \;"
